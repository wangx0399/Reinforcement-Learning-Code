...
atari_env = Atari_Envs[2]

seed = 1000 # Use a seed of zero (you may want to randomize the seed!)
...
RESULT_DIR = '/home/wangxu/Desktop/Reinforcement Learning Code/DQNs/Dueling_DQN/'
